const data = [
  ...
  },
  {
    ...
    ans: [
      {
        text: `<div class="ended">Java <br> <span>Lập trình ứng dụng android, lập trình nhúng,lập trình trong thương mại điệnn tử(các ngân hàng đầu tư lớn, các giao dịch tài chính,..)</span> <br><a href="#">Tìm hiểu thêm</a></div>`, // them span de de style
      },
    ],
  },
  {
    ...
    ans: [
      {
        text: `<div class="ended">Javascript <br> <span>Lập trình website, các ứng dụng cho web,..</span> <br><a href="#">Tìm hiểu thêm</a></div>`,
      },
    ],
  },
  {
    ...
    ans: [
      {
        text: `<div class="ended">Python <br> <span>Lập trình ứng dụng khoa học, vật lý, vi sinh ; phát triển game ; lập trình web ; machine learning/AI</span> <br><a href="#">Tìm hiểu thêm</a></div>`,
      },
    ],
  },
  {
    ...
    ans: [
      {
        text: `<div class="ended">Php  <br> <span>Lập trình web, viết từng dụng</span> <br><a href="#">Tìm hiểu thêm</a></div>`,
      },
    ],
  },
  {
    ...
    ans: [
      {
        text: `<div class="ended">Objective-C  <br> <span>Lập trình viết các ứng dụng cho MacOS,IOS</span> <br><a href="#">Tìm hiểu thêm</a></div> `,
      },
    ],
  },
  {
    ...
    ans: [
      {
        text: `<div class="ended">Ruby  <br> <span>Lập trình ứng dụng, games, phát triển website</span> <br><a href="#">Tìm hiểu thêm</a></div>`,
      },
    ],
  },
  {
    ...
    ans: [
      {
        text: `<div class="ended">C++  <br> <span>Lập trình games, GUI, quản trị cơ sở dữ liệu…</span> <br><a href="#">Tìm hiểu thêm</a></div>`,
      },
    ],
  },
  {
    ...
    ans: [
      {
        text: `<div class="ended">C# <br> <span>Phát triển unity games, lập trình ASP .NET, lập trình tạo nên các phần mềm đa nền tảng</span> <br><a href="#">Tìm hiểu thêm</a></div> `,
      },
    ],
  },
];
